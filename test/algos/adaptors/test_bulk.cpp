...
TEST_CASE("bulk keeps error_types from input sender", "[adaptors][bulk]") {
  ...
  check_err_types<type_array<std::exception_ptr>>( //
      ex::unscoped_transfer(ex::just(), sched1) | ex::bulk(n, [](int) noexcept {}));
  check_err_types<type_array<std::exception_ptr>>( //
      ex::unscoped_transfer(ex::just(), sched2) | ex::bulk(n, [](int) noexcept {}));
  check_err_types<type_array<int>>( //
      ex::just_error(n) | ex::bulk(n, [](int) noexcept {}));
  check_err_types<type_array<std::exception_ptr, int>>( //
      ex::unscoped_transfer(ex::just(), sched3) | ex::bulk(n, [](int) noexcept {}));
  check_err_types<type_array<std::exception_ptr, int>>( //
      ex::unscoped_transfer(ex::just(), sched3) | ex::bulk(n, [](int) { throw std::logic_error{"err"}; }));
}
